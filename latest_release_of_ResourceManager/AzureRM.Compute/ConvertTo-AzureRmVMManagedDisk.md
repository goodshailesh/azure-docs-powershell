...
online version:
schema: 2.0.0
content_git_url: https://github.com/Visual-Studio-China/azure-powershell/blob/preview/src/ResourceManager/Compute/Stack/Commands.Compute/help/ConvertTo-AzureRmVMManagedDisk.md
original_content_git_url: https://github.com/Visual-Studio-China/azure-powershell/blob/preview/src/ResourceManager/Compute/Stack/Commands.Compute/help/ConvertTo-AzureRmVMManagedDisk.md
---
...
```
ConvertTo-AzureRmVMManagedDisk [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [-ResourceGroupName] <String> [-VMName] <String> [<CommonParameters>]
```
