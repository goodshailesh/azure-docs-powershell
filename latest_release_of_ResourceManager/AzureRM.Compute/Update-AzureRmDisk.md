...
online version:
schema: 2.0.0
content_git_url: https://github.com/Visual-Studio-China/azure-powershell/blob/preview/src/ResourceManager/Compute/Stack/Commands.Compute/help/Update-AzureRmDisk.md
original_content_git_url: https://github.com/Visual-Studio-China/azure-powershell/blob/preview/src/ResourceManager/Compute/Stack/Commands.Compute/help/Update-AzureRmDisk.md
---
...
```
Update-AzureRmDisk [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [-ResourceGroupName] <String> [-DiskName] <String> [-DiskUpdate] <DiskUpdate> [<CommonParameters>]
```

### InvokeByDynamicParametersForFriendMethod
```
Update-AzureRmDisk [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [-ResourceGroupName] <String> [-DiskName] <String> [-Disk] <Disk> [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.Management.Compute.Models.DiskUpdate
